import math
import sys
sys.path.append(r'F:\githubClone\deepQ_learning_newVer\nf_dqn_v3_2_LSTM_Attention\ORCA')
# sys.path.append(r'D:\deepQ_learning_newVer\nf_dqn_v3_2_LSTM_Attention\ORCA')
...
class Vector2:
    ...
    def __abs__(self):
        ...
        """
        return math.sqrt(RVOmath.abs_sq(self))